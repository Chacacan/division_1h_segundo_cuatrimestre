...
img_fondo = pygame.image.load(r'Curso_de_ingreso_PYTHON\programacion_I_segundo_cuatri\puntajes\recursos\img\fondo.png')

# Cargamos la imagen de la tabla
img_tabla_puntajes = pygame.image.load(r'Curso_de_ingreso_PYTHON\programacion_I_segundo_cuatri\puntajes\recursos\img\tabla_puntajes.png')
pos_img_tabla_puntajes = ((ANCHO_VENTANA - img_tabla_puntajes.get_width()) // 2, 10)

# Creamos el texto del titulo
font_titulo = pygame.font.Font(r'Curso_de_ingreso_PYTHON\programacion_I_segundo_cuatri\puntajes\recursos\fonts\Halimount.otf', 50)
...
font_boton = pygame.font.Font(r'Curso_de_ingreso_PYTHON\programacion_I_segundo_cuatri\puntajes\recursos\fonts\Halimount.otf', 30)
...
font_tabla = pygame.font.Font(r'Curso_de_ingreso_PYTHON\programacion_I_segundo_cuatri\puntajes\recursos\fonts\Halimount.otf', 35)
lista_puntaje_txt = []
